...
import static com.sh.ec.entity.EquipmentTypeContant.ROW;
...
public final class BluetoothEquipmentConsoleUtils {
    ...
    public static void initConsoleDisplay(Integer sportId, DCEquipment equipment, int equipmentId,
        ...
        if (started) {
            //goDisplay = new DCStringDisplayZone1Parameter(8);//Display GO on old console
            if (equipmentVersion > BluetoothManager.EQUIPMENT_FIRMWARE_1_5 ||
                    equipmentVersion >= consoleNewDisplayIdVersionMap.get(equipmentId)) {
                goDisplay = new DCStringDisplayZone1Parameter(6);//Display GO on console
            } else {
                goDisplay = new DCStringDisplayZone1Parameter(8);//Display GO on old console
            }
        ...
        switch (sportId) {
            case TypeConstants.TYPE_SPORT_TREADMILL:
                DCTreadmillDisplayZoneParameters treadmillDisplayZoneParameters = new DCTreadmillDisplayZoneParameters();
                for (DCUnit dcUnit : treadmillAvailableZones) {
                    prepareTreadmillZoneDisplay(treadmillDisplayZoneParameters, equipmentId, dcUnit, 0f);
                }
                treadmillDisplayZoneParameters.setDisplayZone1Parameter(goDisplay);
    ...
    public static void setBikeClockDisplayZones(DCBike dcBike,int hour,int min){

        DCBikeDisplayZoneParameters parameters = new DCBikeDisplayZoneParameters();
        parameters.setDisplayZone1Parameter(new DCClockDisplayZone1Parameter(hour, min));

        dcBike.setDisplayZones(parameters, new DCCompletionBlock() {

            @Override
            public void completed(DCEquipment equipment) {
    ...
    public static void setEllipticalTrainerClockDisplayZones(DCEllipticalTrainer ellipticalTrainer,int hour,int min){

        DCEllipticalTrainerDisplayZoneParameters parameters = new DCEllipticalTrainerDisplayZoneParameters();
        parameters.setDisplayZone1Parameter(new DCClockDisplayZone1Parameter(hour, min));

        ellipticalTrainer.setDisplayZones(parameters, new DCCompletionBlock() {
    ...
    public static void setRoweClockDisplayZones(DCRower rower,int hour,int min){

        DCDisplayZoneParameters parameters = new DCDisplayZoneParameters();
        parameters.setDisplayZone1Parameter(new DCClockDisplayZone1Parameter(hour, min));

        rower.setDisplayZones(parameters, new DCCompletionBlock() {
    ...
    public static void setTreadmillClockDisplayZones(DCTreadmill treadmill,int hour,int min){

        DCTreadmillDisplayZoneParameters parameters = new DCTreadmillDisplayZoneParameters();
        parameters.setDisplayZone1Parameter(new DCClockDisplayZone1Parameter(hour, min));

        treadmill.setDisplayZones(parameters, new DCCompletionBlock() {
    ...
    public static void setClockZones(DCEquipment dcEquipment,int vale1,int vale2){
        ...
        if (name.contains(BIKE)) {
            ...
            setBikeClockDisplayZones((DCBike) dcEquipment,vale1,vale2);

        } else if (name.contains(EPLLPTICAL)) {
                setEllipticalTrainerClockDisplayZones((DCEllipticalTrainer)dcEquipment,vale1,vale2);
        } else if (name.contains(TREADMILL)) {
            setTreadmillClockDisplayZones((DCTreadmill) dcEquipment,vale1,vale2);

        }else if(name.contains(ROW)){
           setRoweClockDisplayZones((DCRower)dcEquipment,vale1,vale2);
